const en = {
  ...
  form: {
    ...
    finance: {
      ...
      businessSection: "Business use (Osek Murshe)",
      ...
      businessTitle: "Work benefits",
      businessSubtitle: "Whether you're a licensed business, and what your workplace reimburses for the car — both affect the final cost.",
      workplaceSectionBuy: "Workplace reimbursement — owned car",
      workplaceSectionLease: "Workplace reimbursement — lease car",
      workplaceBenefitLabel: "Net monthly reimbursement (₪)",
      workplaceBenefitHint: "If your workplace reimburses car costs (fuel, insurance, maintenance, mileage, etc.), enter the net monthly amount — after tax — you actually receive. It's subtracted from that option's cost in the comparison.",
    },
    financing: {
  ...
  results: {
    ...
    comparison: {
      ...
      residualEditLabel: "Estimated sale value at end of period (₪)",
      residualEditHint: "Enter what you expect to get from selling the car at the end of the period.",
      applyBtn: "Update",
      resetBtn: "Reset",
      taxBenefits: "Tax Benefits",
      workplaceBenefit: "Workplace Reimbursement",
